...
public class TemperatureView extends View {
    ...
    private void initAttr(Context context, AttributeSet attrs){
        ...
        try {
//            int size = (int) typedArray.getDimension(R.styleable.TemperatureView_cv_Radius, 100);
    ...
    private void initTemperature() {
        ...
        int leftText = 0;
        paintText.setTextSize((int)(radius/3.6));
        if (temperature < -9) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(sTemperature, (canvas.getWidth()-radius)/2 + leftText, (int)(1.2*radius), paintText);
